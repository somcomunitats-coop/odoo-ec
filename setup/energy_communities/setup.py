...
setuptools.setup(
    ...
    odoo_addon={
        "depends_override": {
            ...
            "energy_communities_mass_mailing": "odoo14-addon-energy-communities-mass-mailing==14.0.0.1.0",
            "energy_selfconsumption": "odoo14-addon-energy-selfconsumption==14.0.3.6.1",
