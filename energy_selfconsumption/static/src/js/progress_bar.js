odoo.define('energy_selfconsumption.ProgressBarWidget', function (require) {
    ...
    var ProgressBarWidget = AbstractField.extend({
        ...
        init: function (parent, state, params) {
            ...
            this.percentage = Math.min((this.current_quantity / this.max_quantity) * 100, 100);  // Porcentaje
        },
            ...
            this.$el.html(`
                <div class="o_progress_bar">
                    <div class="progress-bar-container" style="position: relative; height: 25px; background-color: #f5f5f5; border-radius: 4px; border: 1px solid #ccc;">
                        <div class="progress-bar-green" style="width: ${this.percentage}%; height: 100%; background-color: green;"></div>
                    ...
                    <span style="display: block;float: right;">${this.current_quantity.toFixed(2)} / ${this.max_quantity.toFixed(2)}</span>
                </div>
            `);
        },
    });
