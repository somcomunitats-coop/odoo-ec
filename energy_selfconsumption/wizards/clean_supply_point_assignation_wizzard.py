...
class CleanSupplyPointAssignationWizard(models.TransientModel):
    ...
    def default_get(self, fields):
        res = super(CleanSupplyPointAssignationWizard, self).default_get(fields)
        res['message'] = _("Are you sure you want to delete all assigned distribution points?")
        return res
    ...
    def action_confirm(self):
        ...
        for active_id in active_ids:
            ...
            if distribution_table.state != "draft":
                raise ValidationError(_("You can only delete assigned distribution points from a distribution table if it is in draft status"))
