{
    ...
    "description": """
        This module fixes the issue where email body content is lost when
        creating CRM leads from incoming emails when no matching partner
        exists in the database.

        Features:
        - Automatically creates a partner when processing emails without
          existing contacts
        - Marks auto-created partners with a special tag for identification
        - Ensures email body and attachments are properly saved in lead
          chatter
